...
# ~  03/2022 parece que las pelis tambien con recaptcha
...
def play(item):
    ...
    if item.url.startswith(host) and '/links/' in item.url:
        ...
        if '/www.pastexts' in url or '/tmearn' in url or '/sturl' in url or '/uii' in url or '/uiio' in url or '/down.fast-' in url or '/adshort' in url or '/passgen' in url:
