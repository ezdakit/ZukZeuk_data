...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = 'ZukZeuk WIZARD'
BUILDERNAME = 'OpenWizard'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://ezdakit.github.io/ZukZeuk_data/wizard_K19/builds.txt'
# How often you would like it to check for build updates in days
# 0 being every startup of kodi
UPDATECHECK = 0
# Text File with apk info in it.  Leave as 'http://' to ignore
APKFILE = 'https://ezdakit.github.io/ZukZeuk_data/wizard_K19/apks.txt'
...
REPOID = 'repository.zukzeuk'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/ezdakit/ZukZeuk_repo/main/matrix/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/ezdakit/ZukZeuk_repo/main/matrix/repository.zukzeuk/'
#########################################################
