...
if CONFIG.get_setting('first_install') == 'true':
    ...
    #RFB window.show_save_data_settings()
else:
...
# SHOW NOTIFICATIONS
#RFB if CONFIG.ENABLE_NOTIFICATION == 'Yes':
    #RFB show_notification()
#RFB else:
    #RFB logging.log('[Notifications] Not Enabled', level=xbmc.LOGINFO)
